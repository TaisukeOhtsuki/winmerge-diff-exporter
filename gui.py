...
class DiffApp(QWidget):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("WinMerge Diff â†? Excel")
    ...
    def setup_widgets(self) -> None:
        ...
        self.run_button = QPushButton("â‘£ Run (Compare and Export to Excel)")
    ...
    def setup_layout(self) -> None:
        ...
        title = QLabel("WinMerge Diff â†? Excel")
        title.setFont(QFont("Helvetica", 20))
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(title)

        layout.addLayout(self.create_path_row("â‘? Base Folder", self.base_input, self.browse_base))
        layout.addLayout(self.create_path_row("â‘¡ Comparison Target Folder", self.latest_input, self.browse_latest))
        layout.addLayout(self.create_path_row("â‘¢ Output File", self.output_input, self.browse_output))
